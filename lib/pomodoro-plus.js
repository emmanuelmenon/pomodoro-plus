...
export default {
    config: {
        ...
        runAtStartup_cfg: {
            title: 'Start With Atom\?',
            type: 'boolean',
            default: true,
        },
        saveTimer_cfg: {
            title: 'Save When Timer Starts\?',
            type: 'boolean',
            default: true,
        }
    },
    ...
    activate(state) {
        ...
        if (atom.config.get("pomodoro-plus.runAtStartup_cfg")) {
            this.check();
        }
    },
    ...
    begin() {
        ...
        function pomodoro() {
            ...
            function saveFiles() {
                if (atom.config.get("pomodoro-plus.saveTimer_cfg")) { //only run save, if check in cfg
